...
import { BuildingIcon, LayoutDashboardIcon, ListCollapseIcon, ListIcon, PlusSquareIcon } from 'lucide-react'
...
const AdminSidebar = () => {
    ...
    const adminNavlinks=[
        ...
        {name:'Add Theater', path:'/admin/add-theater', icon: BuildingIcon}
